...
<head>
    ...
    <!-- owl carousel -->
    <link rel="stylesheet" type="text/css" href="{{url('owl/owl.carousel.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('owl/owl.theme.default.min.css')}}">
...
<!-- owl carousel -->
<script src="{{url('owl/jquery.min.js')}}"></script>
